...
const ChatMessage = ({ message }: ChatMessageProps) => {
  ...
  const renderSourceBadge = () => {
    ...
    } else if (sourceInfo?.source === 'internet_knowledge') {
      badgeText = "Internet + Database";
        ...
        <HoverCardContent className="w-80">
          <div className="space-y-2">
            ...
            {sourceInfo?.source === 'product_database' ? (
              ...
              <p className="text-sm">Response combines database information with general knowledge from internet sources.</p>
            ...
            {sourceInfo?.ingredient && (
              <p className="text-sm mt-1">
                <span className="font-medium">Ingredient query:</span> {sourceInfo.ingredient}
              </p>
            )}
